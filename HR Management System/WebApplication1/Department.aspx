<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Department.aspx.cs" Inherits="WebApplication1.Registerleave" %>
	   ...
	   <div class="xs">
          ...
          <fieldset>
            <div class="form-group" id="2">  
              <label class="control-label">Department ID</label><asp:TextBox ID="TextBox2" runat="server" Height="40px" class="form-control1 ng-invalid ng-valid-email ng-invalid-required ng-touched" Width="980px" ng-model="model.name" required=""></asp:TextBox>
            </div>
