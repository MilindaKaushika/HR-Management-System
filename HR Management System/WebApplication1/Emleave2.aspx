<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Emleave2.aspx.cs" Inherits="WebApplication1.Emleave2" %>
...
<div id="wrapper">
           ...
           <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu1">
                        ...
                        <li>
                            <a href="HR.aspx" class="isDisabled"><i class="fa fa-laptop nav_icon" class="isDisabled"></i>Employeres Details<span class="fa arrow"></span></a>
                              <ul class="nav nav-second-level">
                                <li>
                                     <a href="Employregadmin.aspx" class="isDisabled">Add Employeres</a>
                             
                                </li>
                                <li>
                                          <a href="Employeetable.aspx" class="isDisabled">Employere Table</a>
                                </li>
                            </ul> 
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="#" class="isDisabled"><i class="fa fa-indent nav_icon" class="isDisabled"></i>Department Details<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="Department.aspx" class="isDisabled">Add Departments</a>
                                </li>
 ...
 <a href="#" class="isDisabled"><i class="fa fa-indent nav_icon" class="isDisabled"></i>Employeer Salary<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="salarypayment.aspx" class="isDisabled">Salary calculation</a>
                                </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
     ...
     <asp:TextBox ID="TextBox4" runat="server"  Height="40px" class="form-control1 ng-invalid ng-invalid-required" Width="980px" ng-model="model.password" required="" ></asp:TextBox>
            </div>
     ...
     <asp:TextBox ID="TextBox8" runat="server"  Height="40px" class="form-control1 ng-invalid ng-invalid-required" Width="980px"  ng-model="model.password" required="" ></asp:TextBox>
            </div>
            <div class="form-group filled">
 <label class="control-label">Leave Apply Start Date</label>
              <asp:TextBox ID="TextBox1" runat="server" type="date" Height="40px" class="form-control1 ng-invalid ng-invalid-required" Width="980px"  ng-model="model.password" required="" Enabled="False"></asp:TextBox>
            </div>
                     <div class="form-group filled">
 <label class="control-label">Leave Apply End Date</label>
                <asp:TextBox ID="TextBox2" runat="server" type="date" Height="40px" class="form-control1 ng-invalid ng-invalid-required" Width="980px"  ng-model="model.password" required="" Enabled="False"></asp:TextBox>
            </div>
                <div class="form-group filled">
